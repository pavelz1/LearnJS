window.addEventListener('DOMContentLoaded', () => {
	...
	const
		...
		inputCalcSquare = calcBlock.querySelector('.calc-square'),
		inputCalcCount = calcBlock.querySelector('.calc-count'),
		inputCalcDay = calcBlock.querySelector('.calc-day');
	...
	for (let img of document.querySelectorAll('[data-img]')) {
